...
public class Prints {
  ...
  // *************************************************************************** messages
    ...
    public static void genPrint(Tuple e) {
      if (e.getB().equals("char")) {   
        _printc(e.getA()+"");
      } else {
        _print(e.getA()+"");
      }
    ...
    public static void _printc(String e) {
      out.println("\tprintc " + e + ";");
    }
    ...
    public static Tuple operate(Tuple e1, int oper, Tuple e2) {
      ...
      if ((oper == POR || oper == DIV) && (e1.getB().equals("char") || e2.getB().equals("char")))
      {
        comment("Type Error");
        error();
        halt();
      ...
      if (e1.getB().equals("float") && e2.getB().equals("float")) {
        ...
        type = "float";
        opr = "r ";
      } else if (e1.getB().equals("char") || e2.getB().equals("char")) {
        type = "int";
      }
    ...
    public static char getChar(String in) {
      char c = in.charAt(0);
      if (in.length() > 2) { // \u0043
        String aux = in.substring(2, in.length());
        c = (char) Integer.parseInt(aux, 16);
      } else if (in.length() == 2) { // \b
        c = in.charAt(1);
      } else if (in.length() == 1) { // b
        c = in.charAt(0);
      } else {
        complexError(3);
      }
    ...
    public static Tuple<String, String> doVirgu(String id, String tipo) {
      String temp = GenTag.genTemp();
      DoubleTag tag = new DoubleTag();
      out.println("\t" + temp + " = " + id + ";");
      out.println("\tif (" + id + " < 65) goto " + tag.getT() + ";");
      out.println("\tif ( 122 < " + id + ") goto " + tag.getT() + ";");
      out.println("\tif ( 96 < " + id + ") goto " + tag.getF() + ";");
      out.println("\tif ( 90 < " + id + ") goto " + tag.getT() + ";");
      ...
      return new Tuple(temp, "char");
    }

    public static Tuple<String, String> doNot(String id, String tipo) {
      String temp = GenTag.genTemp();
      DoubleTag tag = new DoubleTag();
      out.println("\t" + temp + " = " + id + ";");
      out.println("\tif (" + id + " < 97) goto " + tag.getT() + ";");
      out.println("\tif ( 122 < " + id + ") goto " + tag.getT() + ";");
      out.println("\t" + temp + " = " + id + " - 32;");
      label(tag.getT());
    ...
    public static void doForEach(String id, String str, DoubleTag dt) {
      String temp = GenTag.genTemp();
      int tam = -1;
    ...
    public static void complexError(int errorCode){
      ...
      switch (errorCode) {
        ...
        case 2:
          ...
          break;
        case 3:
          out.println("\tError: SyntaxError, Unexpected character");
          break;
        default:
