...
"(string)"          {return new Symbol(sym.CAST_STRING);}
...
/*Char*/
(\'[^']\') | (\'\\[bnfrt\"\'\\]\') | (\'\\u[a-f0-9A-F]{4}\')  {return new Symbol(sym.CHARACTER, yytext().substring(1, yytext().length() - 1));}
